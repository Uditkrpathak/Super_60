...
const Carousel = () => {
  ...
  const cards = [
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1565299624946-b28f40a0ca4b?w=600&h=800&fit=crop",
  ...
  return (
    <div className="w-full bg-transparent relative overflow-visible">
      {/* Curved top divider */}
      <div className="absolute top-0 left-0 w-full h-32 bg-transparent z-20">
        <svg 
      ...
      <div className="relative pt-20 pb-32 z-30">
        <div className="max-w-7xl mx-auto px-8">
          {/* Cards container with fixed height */}
          <div className="relative" style={{ height: '400px' }}>
            <div className="flex items-end justify-center gap-6 absolute bottom-0 left-0 right-0">
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      filter: isHovered ? 'drop-shadow(0 25px 50px rgba(139, 92, 246, 0.3))' : 'drop-shadow(0 10px 30px rgba(0, 0, 0, 0.3))',
                      padding: '8px'
                    }}
                      ...
                      <div className="relative h-full flex flex-col justify-end p-8">
                        <div className="text-white">
                          <h3 className={`
                            ...
                            ${isHovered ? 'text-3xl transform -translate-y-2' : 'text-xl'}
                          `}>
                            {card.title}
                          </h3>
                          <p className={`
                            text-gray-200 transition-all duration-500 leading-relaxed
                            ${isHovered ? 'text-lg opacity-100 transform -translate-y-1' : 'text-base opacity-70'}
                          `}>
                            {card.subtitle}
                          </p>
                          ...
                          `}>
                            ...
                            <div className="ml-3 w-8 h-8 rounded-full bg-purple-500/20 flex items-center justify-center">
      ...
      <div className="absolute top-1/4 left-10 w-96 h-96 bg-purple-500/5 rounded-full blur-3xl animate-pulse z-30" />
      <div className="absolute bottom-1/4 right-10 w-80 h-80 bg-blue-500/5 rounded-full blur-3xl animate-pulse delay-1000 z-30" />
    </div>
  );
};
