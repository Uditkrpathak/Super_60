...
const TrainingSchedule = () => {
    ...
    return (
        <section className="">
            {/* Header */}
            <div className="bg-gray-200 px-32 py-6 flex gap-4">
                <div className="inline-block w-1 h-24 bg-zinc-600 rounded-md"></div>
                <div>
                    <h2 className="text-md font-medium text-left text-gray-800 pt-4">
                        Program Structure
                    </h2>
            ...
            {/* About */}
            <div className="w-full px-32 mx-auto py-10">
                ...
                <p className="text-gray-700 leading-snug pr-48">
            ...
            <section className="py-10 px-20">
                ...
                <div className="flex justify-center flex-wrap gap-5 mb-10">
                    {["first", "second", "third", "fourth"].map((id, i) => {
                        ...
                        let translateClass = "";
                        if (selectedIndex !== -1) {
                            if (i < selectedIndex) translateClass = "-translate-x-3";
                            else if (i > selectedIndex) translateClass = "translate-x-3";
                        }
                        ...
                        return (
                            <span
                                ...
                                className={`relative inline-block transform transition-transform duration-500 ease-in-out text-sm md:text-base font-semibold px-6 py-2 rounded-xl border cursor-pointer
                                    ${isActive
                                        ? "bg-gradient-to-r from-blue-100 to-blue-300 text-blue-900 border-blue-300 shadow-lg scale-125 z-10"
                ...
                {/* Content & Path */}
                <div className="flex flex-col md:flex-row justify-center items-start gap-6 px-4 pb-10">
                    {/* SVG Path */}
